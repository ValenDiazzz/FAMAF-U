...
int main(void) {
    ...
    copy = string_clone(original, sizeof(char)*str_length(original));
    printf("Original: %s\n", original);
    copy[0] = 'A';
    copy[1] = ' ';
    copy[2] = 'l';
...
/*
el problema radica en que clone estaba en memoria estàtica
y es una variable local. Por lo tanto, cuando se quiere utilicar 
la informacion de la variable clone a traves de un puntero de salida
